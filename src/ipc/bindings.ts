...
const ARGS_MAP = {'security':'{"getWhiteList":[]}', 'almanax':'{"get":["level","date"]}', 'base':'{"newId":[],"isProduction":[],"openUrl":["url"]}', 'guides':'{"downloadGuideFromServer":["guide_id","folder"],"getGuideFromServer":["guide_id"],"getFlatGuides":["folder"],"getGuidesFromServer":["status"],"openGuidesFolder":[],"copyCurrentGuideStep":[],"hasGuidesNotUpdated":[],"updateAllAtOnce":[],"getGuides":["folder"],"getGuideSummary":["guide_id"],"deleteGuidesFromSystem":["guides_or_folders_to_delete"]}', 'api':'{"isAppVersionOld":[]}', 'conf':'{"reset":[],"set":["conf"],"get":[],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"]}', 'update':'{"startUpdate":[]}', 'report':'{"send_report":["payload"]}', 'image':'{"fetchImage":["url"]}'}
