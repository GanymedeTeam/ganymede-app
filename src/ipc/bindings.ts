...
const ARGS_MAP = {'base':'{"newId":[],"openUrl":["url"],"isProduction":[]}', 'almanax':'{"get":["level","date"]}', 'guides':'{"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"copyCurrentGuideStep":[],"getGuidesFromServer":["status"],"getFlatGuides":["folder"],"getGuideFromServer":["guide_id"],"getGuides":["folder"],"getGuideSummary":["guide_id"],"downloadGuideFromServer":["guide_id","folder"],"updateAllAtOnce":[],"openGuidesFolder":[],"hasGuidesNotUpdated":[]}', 'report':'{"send_report":["payload"]}', 'update':'{"startUpdate":[]}', 'security':'{"getWhiteList":[]}', 'image':'{"fetchImage":["url"]}', 'api':'{"isAppVersionOld":[]}', 'conf':'{"reset":[],"get":[],"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"]}'}
