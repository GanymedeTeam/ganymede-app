...
const ARGS_MAP = {'guides':'{"getGuideFromServer":["guide_id"],"getGuidesFromServer":["status"],"openGuidesFolder":[],"getFlatGuides":["folder"],"downloadGuideFromServer":["guide_id","folder"],"hasGuidesNotUpdated":[],"guideExists":["guide_id"],"getGuides":["folder"],"updateAllAtOnce":[],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"getGuideSummary":["guide_id"],"copyCurrentGuideStep":[]}', 'image':'{"fetchImage":["url"]}', 'api':'{"isAppVersionOld":[]}', 'base':'{"isProduction":[],"newId":[],"openUrl":["url"]}', 'almanax':'{"get":["level","date"]}', 'security':'{"getWhiteList":[]}', 'update':'{"startUpdate":[]}', 'report':'{"send_report":["payload"]}', 'conf':'{"reset":[],"get":[],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"set":["conf"]}', 'deep_link':'{"openGuideRequest":["guide_id","step"]}'}
