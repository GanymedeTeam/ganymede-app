...
const ARGS_MAP = {'report':'{"send_report":["payload"]}', 'security':'{"getWhiteList":[]}', 'almanax':'{"get":["level","date"]}', 'base':'{"isProduction":[],"openUrl":["url"],"newId":[]}', 'image':'{"fetchImage":["url"]}', 'conf':'{"reset":[],"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"get":[]}', 'update':'{"startUpdate":[]}', 'api':'{"isAppVersionOld":[]}', 'guides':'{"updateAllAtOnce":[],"getGuidesFromServer":["status"],"getGuideSummary":["guide_id"],"getGuideFromServer":["guide_id"],"getGuides":["folder"],"openGuidesFolder":[],"copyCurrentGuideStep":[],"hasGuidesNotUpdated":[],"downloadGuideFromServer":["guide_id","folder"],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"getFlatGuides":["folder"]}'}
