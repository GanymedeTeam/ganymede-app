...
const ARGS_MAP = {'image':'{"fetchImage":["url"]}', 'conf':'{"get":[],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"set":["conf"],"reset":[]}', 'base':'{"newId":[],"openUrl":["url"],"isProduction":[]}', 'update':'{"startUpdate":[]}', 'api':'{"isAppVersionOld":[]}', 'deep_link':'{"openGuideRequest":["guide_id","step"]}', 'guides':'{"updateAllAtOnce":[],"hasGuidesNotUpdated":[],"getFlatGuides":["folder"],"guideExists":["guide_id"],"downloadGuideFromServer":["guide_id","folder"],"getGuideFromServer":["guide_id"],"getGuidesFromServer":["status"],"getGuides":["folder"],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"getGuideSummary":["guide_id"],"copyCurrentGuideStep":[],"openGuidesFolder":[]}', 'almanax':'{"get":["level","date"]}', 'security':'{"getWhiteList":[]}', 'report':'{"send_report":["payload"]}', 'notifications':'{"markNotificationAsViewed":["notification_id"],"getViewedNotifications":[],"getUnviewedNotifications":[]}'}
