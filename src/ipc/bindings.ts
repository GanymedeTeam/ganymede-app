...
const ARGS_MAP = {'security':'{"getWhiteList":[]}', 'almanax':'{"get":["level","date"]}', 'base':'{"openUrl":["url"],"isProduction":[],"newId":[]}', 'image':'{"fetchImage":["url"]}', 'conf':'{"reset":[],"get":[],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"set":["conf"]}', 'api':'{"isAppVersionOld":[]}', 'guides':'{"getGuidesFromServer":["status"],"downloadGuideFromServer":["guide_id","folder"],"getGuideSummary":["guide_id"],"openGuidesFolder":[],"updateAllAtOnce":[],"hasGuidesNotUpdated":[],"getGuides":["folder"],"getGuideFromServer":["guide_id"],"copyCurrentGuideStep":[],"getFlatGuides":["folder"],"deleteGuidesFromSystem":["guides_or_folders_to_delete"]}', 'report':'{"send_report":["payload"]}', 'update':'{"startUpdate":[]}'}
