...
const ARGS_MAP = {'api':'{"isAppVersionOld":[]}', 'security':'{"getWhiteList":[]}', 'update':'{"startUpdate":[]}', 'notifications':'{"markNotificationAsViewed":["notification_id"],"getUnviewedNotifications":[],"getViewedNotifications":[]}', 'image':'{"fetchImage":["url"]}', 'guides':'{"getGuideFromServer":["guide_id"],"getGuidesFromServer":["status"],"openGuidesFolder":[],"updateAllAtOnce":[],"hasGuidesNotUpdated":[],"downloadGuideFromServer":["guide_id","folder"],"guideExists":["guide_id"],"copyCurrentGuideStep":[],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"getFlatGuides":["folder"],"getGuideSummary":["guide_id"],"getGuides":["folder"]}', 'conf':'{"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"reset":[],"get":[]}', 'base':'{"openUrl":["url"],"isProduction":[],"newId":[]}', 'report':'{"send_report":["payload"]}', 'almanax':'{"get":["level","date"]}', 'deep_link':'{"openGuideRequest":["guide_id","step"]}'}
