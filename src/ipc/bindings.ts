...
const ARGS_MAP = {'base':'{"newId":[],"isProduction":[],"openUrl":["url"]}', 'api':'{"isAppVersionOld":[]}', 'security':'{"getWhiteList":[]}', 'image':'{"fetchImage":["url"]}', 'update':'{"startUpdate":[]}', 'guides':'{"openGuidesFolder":[],"downloadGuideFromServer":["guide_id","folder"],"getGuideSummary":["guide_id"],"getGuideFromServer":["guide_id"],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"copyCurrentGuideStep":[],"getGuides":["folder"],"getFlatGuides":["folder"],"getGuidesFromServer":["status"],"updateAllAtOnce":[],"hasGuidesNotUpdated":[]}', 'report':'{"send_report":["payload"]}', 'conf':'{"reset":[],"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"get":[]}', 'almanax':'{"get":["level","date"]}'}
