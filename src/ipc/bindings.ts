...
const ARGS_MAP = {'update':'{"startUpdate":[]}', 'conf':'{"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"get":[],"reset":[]}', 'api':'{"isAppVersionOld":[]}', 'base':'{"openUrl":["url"],"isProduction":[],"newId":[]}', 'security':'{"getWhiteList":[]}', 'image':'{"fetchImage":["url"]}', 'almanax':'{"get":["level","date"]}', 'guides':'{"getGuideSummary":["guide_id"],"getFlatGuides":["folder"],"getGuidesFromServer":["status"],"downloadGuideFromServer":["guide_id","folder"],"hasGuidesNotUpdated":[],"updateAllAtOnce":[],"openGuidesFolder":[],"getGuides":["folder"],"getGuideFromServer":["guide_id"],"copyCurrentGuideStep":[],"deleteGuidesFromSystem":["guides_or_folders_to_delete"]}', 'report':'{"send_report":["payload"]}'}
