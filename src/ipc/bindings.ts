...
const ARGS_MAP = {
  ...
  guides:
    '{"getFlatGuides":["folder"],"getGuideSummary":["guide_id"],"getGuideFromServer":["guide_id"],"getGuidesFromServer":["status"],"updateAllAtOnce":[],"openGuidesFolder":[],"getGuides":["folder"],"hasGuidesNotUpdated":[],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"downloadGuideFromServer":["guide_id","folder"],"copyCurrentGuideStep":[]}',
  conf: '{"set":["conf"],"reset":[],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"get":[]}',
}
