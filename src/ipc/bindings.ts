...
const ARGS_MAP = {'almanax':'{"get":["level","date"]}', 'guides':'{"hasGuidesNotUpdated":[],"getGuidesFromServer":["status"],"getGuides":["folder"],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"openGuidesFolder":[],"getGuideSummary":["guide_id"],"updateAllAtOnce":[],"copyCurrentGuideStep":[],"getFlatGuides":["folder"],"getGuideFromServer":["guide_id"],"downloadGuideFromServer":["guide_id","folder"]}', 'security':'{"getWhiteList":[]}', 'conf':'{"get":[],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"reset":[],"set":["conf"]}', 'base':'{"openUrl":["url"],"isProduction":[],"newId":[]}', 'image':'{"fetchImage":["url"]}', 'update':'{"startUpdate":[]}', 'report':'{"send_report":["payload"]}', 'api':'{"isAppVersionOld":[]}'}
