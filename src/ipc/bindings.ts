...
const ARGS_MAP = {'security':'{"getWhiteList":[]}', 'guides':'{"getGuides":["folder"],"copyCurrentGuideStep":[],"openGuidesFolder":[],"getGuideSummary":["guide_id"],"getGuidesFromServer":["status"],"downloadGuideFromServer":["guide_id","folder"],"updateAllAtOnce":[],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"hasGuidesNotUpdated":[],"getGuideFromServer":["guide_id"],"getFlatGuides":["folder"]}', 'report':'{"send_report":["payload"]}', 'base':'{"openUrl":["url"],"isProduction":[],"newId":[]}', 'image':'{"fetchImage":["url"]}', 'almanax':'{"get":["level","date"]}', 'conf':'{"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"get":[],"reset":[]}', 'api':'{"isAppVersionOld":[]}', 'update':'{"startUpdate":[]}'}
