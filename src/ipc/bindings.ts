...
const ARGS_MAP = {'conf':'{"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"get":[],"reset":[]}', 'api':'{"isAppVersionOld":[]}', 'base':'{"isProduction":[],"newId":[],"openUrl":["url"]}', 'almanax':'{"get":["level","date"]}', 'image':'{"fetchImage":["url"]}', 'update':'{"startUpdate":[]}', 'security':'{"getWhiteList":[]}', 'guides':'{"getGuideFromServer":["guide_id"],"openGuidesFolder":[],"getGuides":["folder"],"getFlatGuides":["folder"],"copyCurrentGuideStep":[],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"getGuideSummary":["guide_id"],"getGuidesFromServer":["status"],"downloadGuideFromServer":["guide_id","folder"],"updateAllAtOnce":[],"hasGuidesNotUpdated":[]}', 'report':'{"send_report":["payload"]}'}
