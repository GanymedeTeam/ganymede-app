...
const ARGS_MAP = {'update':'{"startUpdate":[]}', 'conf':'{"reset":[],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"],"set":["conf"],"get":[]}', 'report':'{"send_report":["payload"]}', 'image':'{"fetchImage":["url"]}', 'api':'{"isAppVersionOld":[]}', 'guides':'{"downloadGuideFromServer":["guide_id","folder"],"hasGuidesNotUpdated":[],"copyCurrentGuideStep":[],"openGuidesFolder":[],"getGuides":["folder"],"getGuidesFromServer":["status"],"getFlatGuides":["folder"],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"getGuideSummary":["guide_id"],"getGuideFromServer":["guide_id"],"updateAllAtOnce":[]}', 'almanax':'{"get":["level","date"]}', 'security':'{"getWhiteList":[]}', 'base':'{"openUrl":["url"],"isProduction":[],"newId":[]}'}
