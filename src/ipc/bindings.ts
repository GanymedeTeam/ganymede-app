...
const ARGS_MAP = {'base':'{"openUrl":["url"],"isProduction":[],"newId":[]}', 'almanax':'{"get":["level","date"]}', 'update':'{"startUpdate":[]}', 'deep_link':'{"openGuideRequest":["guide_id","step"]}', 'security':'{"getWhiteList":[]}', 'image':'{"fetchImage":["url"]}', 'guides':'{"getGuides":["folder"],"getGuideFromServer":["guide_id"],"guideExists":["guide_id"],"getGuideSummary":["guide_id"],"downloadGuideFromServer":["guide_id","folder"],"getFlatGuides":["folder"],"updateAllAtOnce":[],"hasGuidesNotUpdated":[],"getGuidesFromServer":["status"],"deleteGuidesFromSystem":["guides_or_folders_to_delete"],"openGuidesFolder":[],"copyCurrentGuideStep":[]}', 'api':'{"isAppVersionOld":[]}', 'conf':'{"reset":[],"get":[],"set":["conf"],"toggleGuideCheckbox":["guide_id","step_index","checkbox_index"]}', 'notifications':'{"getUnviewedNotifications":[],"getViewedNotifications":[],"markNotificationAsViewed":["notification_id"]}', 'report':'{"send_report":["payload"]}'}
