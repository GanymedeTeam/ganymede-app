...
export function AlmanaxCard() {
    ...
    return (
        <div className="flex flex-col gap-3 p-3 bg-surface-card rounded-xl border border-border-muted shadow-[0_5px_14px_rgba(0,0,0,0.5)]">
            ...
            <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1">
                    <Button
                        ...
                        className="size-8 hover:bg-surface-inset/70"
                    >
            ...
            <div className="flex items-center gap-2 text-xs">
                ...
                <div className="flex items-center px-2 py-1 bg-surface-inset rounded-md border border-border-muted hover:border-accent/50 focus-within:border-accent transition-colors cursor-text">
                    <InvisibleInput
                        className="text-left w-8 text-foreground font-semibold"
                        min={1}
                        max={200}
                        value={almanaxLevel}
                            ...
                            <div className="flex flex-col gap-1 min-w-0">
                                <CopyOnClick title={almanax.data.name}>
                                    <div className="flex items-baseline gap-1.5 text-sm">
                                        ...
                                        <span className="font-semibold text-accent-light line-clamp-1">
                                            {almanax.data.name}
                                        </span>
                                    </div>
                                </CopyOnClick>
